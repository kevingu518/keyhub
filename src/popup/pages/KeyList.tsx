      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '8px 12px' }}>
        {keys.value.length === 0 ? (
          <div style={{
            ...
            <p style={{ fontSize: '15px', fontWeight: 600, color: '#94a3b8' }}>No keys yet</p>
            <p style={{ fontSize: '12px', marginTop: '4px' }}>Click "+ Add" to store your first API key</p>
          </div>
        ) : (
          keys.value.map((key) => (
            <KeyCard
